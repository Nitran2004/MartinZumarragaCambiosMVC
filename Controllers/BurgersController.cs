...
using MartinZumarragaCambiosMVC.Data;
using MartinZumarragaCambiosMVC.Models;

namespace MartinZumarragaCambiosMVC.Controllers
{
    public class BurgersController : Controller
    {
        private readonly MartinZumarragaCambiosMVCContext _context;

        public BurgersController(MartinZumarragaCambiosMVCContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Burger != null ? 
                          ...
                          Problem("Entity set 'MartinZumarragaCambiosMVCContext.Burger'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'MartinZumarragaCambiosMVCContext.Burger'  is null.");
            }
            var burger = await _context.Burger.FindAsync(id);
            if (burger != null)
            {
